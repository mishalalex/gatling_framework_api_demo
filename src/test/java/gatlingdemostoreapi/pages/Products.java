package gatlingdemostoreapi.pages;

import gatlingdemostoreapi.utility.Authentication;
import gatlingdemostoreapi.utility.Headers;
...
public class Products {
    ...
    public static ChainBuilder update =
            CoreDsl.exec(Authentication.authenticate)
                    .exec( session -> {
